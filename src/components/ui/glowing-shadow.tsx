...
export function GlowingShadow({ children, onClick, className }: GlowingShadowButtonProps) {
  ...
  return (
    <>
      ...
      <div className={`glow-container ${className}`} role="button" onClick={onClick}>
