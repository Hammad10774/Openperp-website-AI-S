...
import { CheckCircle2, ArrowLeft, Bot, MessageSquare, Phone } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight">
                        AI <span className="text-accent-gold">Chatbots</span> & Conversational AI
                    </h1>
                    <p className="text-xl text-white/50 max-w-2xl mx-auto font-light">
                        Automate your customer interactions across web, social, and voice with intelligent conversational systems.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <ServiceCard
                        ...
                        items={[
                            "AI receptionists",
                            "Call handling",
                            "Appointment booking over phone",
                            "Outbound AI sales calls"
                        ]}
                    />
                </div>
            </div>
