...
import { ArrowLeft, Target, PenTool, Video } from 'lucide-react';
...
export default function AIMarketingServices() {
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <ServiceCard
                        ...
                        items={[
                            "Automated prospect scraping",
                            "Personalized cold email campaigns",
                            "LinkedIn automation",
                            "AI-driven outreach sequences"
                        ]}
                    />
                    <ServiceCard
                        icon={PenTool}
