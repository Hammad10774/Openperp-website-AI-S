...
import { CheckCircle2, ArrowLeft, Brain, BarChart3, FileText } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight">
                        Custom AI <span className="text-accent-gold">Development</span>
                    </h1>
                    <p className="text-xl text-white/50 max-w-2xl mx-auto font-light">
                        Building specialized AI models and intelligence layers tailored exactly to your unique business needs.
                    </p>
                </motion.div>
